  ...
  return (
    <>
      ...
      >
        ...
        sor-pointer flex items-center space-x-2 cursor-pointer ${
          selectedComponent === "Dashboard" ? "bg-gray-700 px-4" : ""
        }`}
          ...
          <button
            className={`w-full py-2 font-medium rounded-md hover:cur
            sor-pointer flex items-center space-x-2 cursor-pointer ${
              selectedComponent === "Books" ? "bg-gray-700 px-4" : ""
            }`}
          ...
          {isAuthenticated && user?.role === "Admin" && (
            <>
              <button
                className={`w-full py-2 font-medium rounded-md hover:cursor-pointer flex items-center space-x-2 cursor-pointer ${
                  selectedComponent === "Catalog" ? "bg-gray-700 px-4" : ""
                }`}
              ...
              <button
                className={`w-full py-2 font-medium rounded-md hover:cursor-pointer flex items-center space-x-2 cursor-pointer ${
                  selectedComponent === "Users" ? "bg-gray-700 px-4" : ""
                }`}
              ...
              <button
                className={`w-full py-2 font-medium rounded-md hover:cursor-pointer flex items-center space-x-2 cursor-pointer ${
                  selectedComponent === "Admin" ? "bg-gray-700 px-4" : ""
                }`}
          ...
          {isAuthenticated && user?.role === "User" && (
            <>
              <button
                className={`w-full py-2 font-medium rounded-md hover:cursor-pointer flex items-center space-x-2 cursor-pointer ${
                  selectedComponent === "Borrowed Books"
                    ? "bg-gray-700 px-4"
                    : ""
                }`}
          ...
          <button
            className={`w-full py-2 font-medium rounded-md hover:cur
            sor-pointer flex items-center space-x-2 cursor-pointer ${
              selectedComponent === "Credentials" ? "bg-gray-700 px-4" : ""
            }`}
        ...
        <button
          className="py-4 font-medium text-center bg-transparent rounded-md hover:cursor-pointer flex items-center justify-center space-x-5 mx-auto w-fit"
        ...
        <IoCloseCircle
          className="h-fit w-fit absolute mt-4 top-0 right-4 block md:hidden text-3xl text-white"
